 ...
 */
#include "random_pacman_impl.h"
#include "agent_utils.h"
#include "random_selector.h"

RandomPacmanImpl::RandomPacmanImpl(const bool controlled)
    : AgentImpl(controlled)
{
}

std::variant<Direction, Stop> RandomPacmanImpl::GetAction(const WorldState& worldState,
                                                          const std::size_t id)
{
    auto current_position = worldState.pacman.point;
